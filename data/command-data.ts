...
// For backward compatibility - this will be used until we fully migrate to the new approach
// This is our original mock data, moved to the Layout category
export const commandDataWithCategories: Category[] = [
  {
    category: "Category 1",
    groups: [
      {
        ...
        classes: [
          {
            item: "Item-1",
            item_meta: "this is the first item",
          },
          {
            item: "Item-2",
            item_meta: "here's another",
          },
          {
            item: "Item-3",
            item_meta: "a favorite item",
          },
          {
            item: "Item-4",
            item_meta: "this one is awesome",
          },
        ],
      },
      {
...
// Export the data with searchable text added (for backward compatibility)
export const commandDataWithSearchableText = commandDataWithCategories.map(addSearchableText)
